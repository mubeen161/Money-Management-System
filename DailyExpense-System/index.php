  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="http://localhost:8505/" class="list-group-item list-group-item-action "><span data-feather="star"></span> Tax Planner</a>
        <a href="http://localhost:8506/" class="list-group-item list-group-item-action "><span data-feather="star"></span> Tax Computation</a>
        <a href="http://127.0.0.1:5501/chatbot/pretext-index%20.html" class="list-group-item list-group-item-action "><span data-feather="star"></span> AI Bot</a>
        <a href="http://localhost:8501/" class="list-group-item list-group-item-action "><span data-feather="star"></span> Debt Payoff Planner</a>
        <a href="http://localhost:8504/" class="list-group-item list-group-item-action "><span data-feather="star"></span> Budget Planning</a>
        <a href="http://localhost:8503/" class="list-group-item list-group-item-action "><span data-feather="activity"></span> Insurance</a>
        <a href="http://localhost/scheduler/admin/?page=appointments" class="list-group-item list-group-item-action "><span data-feather="activity"></span> Investment</a>
        <a href="http://localhost:8502/" class="list-group-item list-group-item-action "><span data-feather="activity"></span> Stocks & Bonds</a>
        <a href="https://splitbill.streamlit.app/" class="list-group-item list-group-item-action "><span data-feather="activity"></span> Bill Splitting</a>
